...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    A: common_vendor.sr("baseForm", "af0db2e8-2,af0db2e8-1"),
    B: common_vendor.p({
    ...
    L: common_vendor.sr("baseForm", "af0db2e8-21,af0db2e8-19"),
    M: common_vendor.p({
    ...
    X: common_vendor.sr("valiForm", "af0db2e8-27,af0db2e8-26"),
    Y: common_vendor.p({
      rules: $data.rules,
    ...
    ak: common_vendor.sr("customForm", "af0db2e8-35,af0db2e8-34"),
    al: common_vendor.p({
    ...
    ar: common_vendor.f($data.dynamicFormData.domains, (item, index, i0) => {
      return {
        a: "af0db2e8-47-" + i0 + "," + ("af0db2e8-46-" + i0),
    ...
    as: common_vendor.sr("dynamicForm", "af0db2e8-43,af0db2e8-42"),
    at: common_vendor.p({
