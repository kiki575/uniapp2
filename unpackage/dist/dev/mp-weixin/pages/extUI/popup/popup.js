...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    y: common_vendor.sr("popup", "3b40b0c6-6"),
    ...
    C: common_vendor.sr("message", "3b40b0c6-7"),
    D: common_vendor.p({
      type: "message"
    }),
    ...
    H: common_vendor.sr("alertDialog", "3b40b0c6-9"),
    I: common_vendor.p({
      type: "dialog"
    }),
    J: common_vendor.sr("inputClose", "3b40b0c6-12,3b40b0c6-11"),
    ...
    M: common_vendor.sr("inputDialog", "3b40b0c6-11"),
    N: common_vendor.p({
      type: "dialog"
    }),
    O: common_vendor.sr("share", "3b40b0c6-13"),
    P: common_vendor.p({
      type: "share",
      safeArea: true,
      backgroundColor: "#fff"
