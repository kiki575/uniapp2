  ...
  return {
    ...
    e: common_vendor.f($data.tableData, (item, index, i0) => {
      return {
        ...
        b: "4083e38a-7-" + i0 + "," + ("4083e38a-6-" + i0),
        c: common_vendor.t(item.name),
        d: "4083e38a-8-" + i0 + "," + ("4083e38a-6-" + i0),
        e: common_vendor.t(item.address),
        f: "4083e38a-9-" + i0 + "," + ("4083e38a-6-" + i0),
        g: "4083e38a-10-" + i0 + "," + ("4083e38a-6-" + i0),
        h: index,
        i: "4083e38a-6-" + i0 + ",4083e38a-0"
      };
    }),
    f: common_vendor.p({
      align: "center"
    }),
    g: common_vendor.sr("table", "4083e38a-0"),
